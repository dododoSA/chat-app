...
class ChannelController extends FOSRestController
{
    ...
    /**
     * @Rest\Put("/api/channel/{name}", name="channel_edit")
     */
    public function updateAction($name, Request $request) {
      ...
      $channel = $this->getDoctrine()->getRepository('AppBundle:Channel')->findOneByName($name);
    ...
    /**
     * @Rest\Delete("/api/channel/{name}", name="channel_delete")
     */
