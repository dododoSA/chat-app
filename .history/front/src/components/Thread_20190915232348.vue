    ...
    methods: {
        postComment: function() {
            ...
            if(this.newComment != '') {
                ...
                axios.post("/api/channel/" + _this.channelName + "/thread", {
                        headers: {
                            Authorization: this.$store.state.accessToken
                        }
                    }, data)
        ...
        postEditComment: function(thread) {
            ...
            if(this.editComment != '') {
                ...
                axios.put("/channel/" + _this.channelName + "/thread/" + thread.id, header, data)
                    .then(function(response) {
        ...
        deleteThread: function(thread) {
            ...
            axios.delete("/api/channel/" + _this.channelName + "/thread/" + thread.id, header)
                .then(function() {
                    axios.get('/api/channel/' + _this.channelName + '/thread', header)
                        .then(function(response) {
                            _this.threads = response.data
